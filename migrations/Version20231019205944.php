 ...
 */
final class Version20231019205944 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE cart_user (cart_id INT NOT NULL, user_id INT NOT NULL, INDEX IDX_6276D670A76ED395 (user_id), INDEX IDX_6276D6701AD5CDBF (cart_id), PRIMARY KEY(cart_id, user_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
